...
void test_gaussian_hmc_reflections(const std::string& polytope_type, unsigned int walk_length) {
    ...
    typename GaussianCRHMCWalk::Walk<Polytope, RNGType> walk(P, interior_point, 1.0, rng);
