                         ...
                         NegativeLogprobFunctor &f) 
{
    ...
    typename WalkTypePolicy::template Walk<
        Polytope, RandomNumberGenerator, NegativeGradientFunctor, NegativeLogprobFunctor, Solver
    ...
    typedef LogconcaveRandomPointGenerator<typename WalkTypePolicy::template Walk<
        Polytope, RandomNumberGenerator, NegativeGradientFunctor, NegativeLogprobFunctor, Solver
                    ...
                    bool raw_output=false) 
{
    ...
    typename CRHMCWalk::template parameters<NT, NegativeGradientFunctor> params(F, P.dimension(), problem.options);
